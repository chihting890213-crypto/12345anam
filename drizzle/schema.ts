...
export const orders = mysqlTable("orders", {
  ...
  orderingPersonName: varchar("senderName", { length: 128 }).notNull(),
  orderingPersonPhone: varchar("senderPhone", { length: 32 }).notNull(),
  orderingPersonEmail: varchar("senderEmail", { length: 320 }),
  taxId: varchar("taxId", { length: 16 }),
  recipientPersonName: varchar("recipientName", { length: 128 }).notNull(),
  recipientPersonPhone: varchar("recipientPhone", { length: 32 }).notNull(),
  recipientPersonAddress: text("recipientAddress"),
