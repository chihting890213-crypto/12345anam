...
export const orders = mysqlTable("orders", {
  ...
  orderingPersonName: varchar("orderingPersonName", { length: 128 }).notNull(),
  orderingPersonPhone: varchar("orderingPersonPhone", { length: 32 }).notNull(),
  orderingPersonEmail: varchar("orderingPersonEmail", { length: 320 }),
  taxId: varchar("taxId", { length: 16 }),
  recipientPersonName: varchar("recipientPersonName", { length: 128 }).notNull(),
  recipientPersonPhone: varchar("recipientPersonPhone", { length: 32 }).notNull(),
  recipientPersonAddress: text("recipientPersonAddress"),
...
export const orderMessages = mysqlTable("order_messages", {
  ...
  orderingPersonName: varchar("orderingPersonName", { length: 128 }),
