...
function Router() {
  ...
  // These pages are ALWAYS public, regardless of auth state
  ...
  // Not authenticated: show landing page (with embedded login) or customer portal
  if (!isAuthenticated) {
    return (
      <Switch>
  ...
  // Authenticated staff/admin: show dashboard inside AppLayout
  return (
    <Switch>
      <Route path="/customer" component={CustomerPortalPage} />
      <Route path="/query" component={CustomerQueryPage} />
